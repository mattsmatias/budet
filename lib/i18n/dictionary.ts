...
const fi = {
  ...
  hero: {
    label: "Ravintolan talous yhdellä silmäyksellä",
  ...
  features: {
    heading: "Kaikki mitä ravintolan talous tarvitsee.",
    receipts: "Kuitit",
  ...
  contact: {
    ...
    body: "Kerro lyhyesti ravintolastasi, niin otamme yhteyttä, näytämme miten Kate toimii ja luomme tunnukset puolestasi.",
    ...
    phone: "Puhelin",
    message: "Viesti",
    messagePlaceholder: "Esim. montako toimipistettä teillä on ja milloin haluaisitte aloittaa.",
    submit: "Lähetä yhteydenottopyyntö",
    sending: "Lähetetään…",
    sentTitle: "Kiitos, viesti on perillä!",
    sentBody: "Otamme sinuun yhteyttä mahdollisimman pian.",
    errRequired: "Täytä nimi, ravintola ja sähköposti.",
...
const en: Dictionary = {
  ...
  hero: {
    label: "Your restaurant's finances at a glance",
  ...
  features: {
    heading: "Everything your restaurant's finances need.",
    receipts: "Receipts",
  ...
  contact: {
    ...
    titleB: "Made simpler.",
    body: "Tell us a little about your restaurant and we'll get in touch, show you how Kate works and set up your accounts.",
    ...
    phone: "Phone",
    message: "Message",
    messagePlaceholder: "For example, how many locations you have and when you'd like to start.",
    submit: "Send request",
    sending: "Sending…",
    sentTitle: "Thank you, we got your message!",
    sentBody: "We'll get in touch with you as soon as possible.",
    errRequired: "Please fill in your name, restaurant and email.",
...
const sv: Dictionary = {
  ...
  hero: {
    label: "Restaurangens ekonomi med en blick",
  ...
  features: {
    heading: "Allt restaurangens ekonomi behöver.",
    receipts: "Kvitton",
  ...
  contact: {
    ...
    titleB: "Enklare.",
    body: "Berätta kort om din restaurang så hör vi av oss, visar hur Kate fungerar och skapar kontona åt dig.",
...
const da: Dictionary = {
  ...
  hero: {
    label: "Restaurantens økonomi med ét blik",
  ...
  features: {
    heading: "Alt hvad restaurantens økonomi har brug for.",
    receipts: "Kvitteringer",
  ...
  contact: {
    ...
    body: "Fortæl kort om din restaurant, så kontakter vi dig, viser hvordan Kate virker og opretter konti for dig.",
    ...
    phone: "Telefon",
    message: "Besked",
    messagePlaceholder: "F.eks. hvor mange afdelinger I har, og hvornår I gerne vil starte.",
    submit: "Send henvendelse",
    sending: "Sender…",
    sentTitle: "Tak, beskeden er modtaget!",
    sentBody: "Vi kontakter dig så hurtigt som muligt.",
    errRequired: "Udfyld navn, restaurant og e-mail.",
...
const tr: Dictionary = {
  ...
  hero: {
    label: "Restoranınızın finansı tek bakışta",
  ...
  benefits: {
    headingA: "Siz restoranı yönetin.",
  ...
  features: {
    heading: "Restoranınızın finansı için gereken her şey.",
    receipts: "Fişler",
  ...
  contact: {
    ...
    titleB: "Daha basit.",
    body: "Bize restoranınızdan kısaca bahsedin; size ulaşalım, Kate'in nasıl çalıştığını gösterelim ve hesaplarınızı oluşturalım.",
    ...
    phone: "Telefon",
    message: "Mesaj",
    messagePlaceholder: "Örneğin kaç şubeniz olduğu ve ne zaman başlamak istediğiniz.",
    submit: "Talep gönder",
    sending: "Gönderiliyor…",
    sentTitle: "Teşekkürler, mesajınız ulaştı!",
    sentBody: "En kısa sürede sizinle iletişime geçeceğiz.",
    errRequired: "Lütfen ad, restoran ve e-posta alanlarını doldurun.",
...
const et: Dictionary = {
  ...
  hero: {
    label: "Restorani rahaasjad ühe pilguga",
  ...
  features: {
    heading: "Kõik, mida restorani rahaasjad vajavad.",
    receipts: "Kviitungid",
  ...
  contact: {
    ...
    titleB: "Lihtsamalt.",
    body: "Räägi lühidalt oma restoranist ja me võtame ühendust, näitame, kuidas Kate töötab, ning loome sinu eest kasutajad.",
    ...
    phone: "Telefon",
    message: "Sõnum",
    messagePlaceholder: "Näiteks mitu tegevuskohta teil on ja millal soovite alustada.",
    submit: "Saada päring",
    sending: "Saadan…",
    sentTitle: "Aitäh, sõnum jõudis kohale!",
    sentBody: "Võtame sinuga ühendust esimesel võimalusel.",
    errRequired: "Täida nimi, restoran ja e-post.",

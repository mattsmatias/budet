...
const ITEMS = [
  { href: "/restoflow/admin", label: "Dashboard", icon: ICONS.home },
  { href: "/restoflow/admin/kuitit", label: "Kuitit", icon: ICONS.receipt },
  { href: "/restoflow/admin/kulut", label: "Kulut", icon: ICONS.chart },
  { href: "/restoflow/admin/tyovuorot", label: "Työvuorot", icon: ICONS.calendar },
  { href: "/restoflow/admin/tyontekijat", label: "Työntekijät", icon: ICONS.users },
  { href: "/restoflow/admin/raportit", label: "Raportit", icon: ICONS.file },
  { href: "/restoflow/admin/ilmoitukset", label: "Ilmoitukset", icon: ICONS.bell },
  { href: "/restoflow/admin/asetukset", label: "Asetukset", icon: ICONS.settings },
] as const;
            ...
            return (
              <li key={item.href}>
                ...
                >
                  ...
                  {item.href === "/restoflow/admin/ilmoitukset" && badgeCount > 0 ? (
                    <span

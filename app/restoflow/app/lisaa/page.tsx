      ...
      <section>
        ...
        <Card padded={false}>
          <ul className="divide-y" style={{ borderColor: "var(--rf-line)" }}>
            <Row href="/restoflow/app/kuitit/uusi" icon={ICONS.camera} label="Lisää kuitti" />
            <Row href="/restoflow/app/vuorot" icon={ICONS.calendar} label="Työvuoroni" />
            <Row href="/restoflow/app/tyoaika" icon={ICONS.clock} label="Työaikani" />
          </ul>
        </Card>
      </section>
